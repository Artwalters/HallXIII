...
export default function ReviewSection() {
  ...
  useEffect(() => {
    ...
    // Create scroll trigger animation - draws in and out on scroll
  ...
  return (
    <section ref={sectionRef} className={styles.section} data-momentum-hover-init="" data-nav-dark="">
      ...
      <div className={styles.ctaWrapper}>
        ...
        >
          Zelf ervaring bij Hal 13?<br />Laat een <span className={styles.ctaUnderlineText} data-cta-scroll-trigger="">review achter<span className={styles.ctaDrawBox} data-cta-draw-box=""></span></span>
        </a>
      </div>
