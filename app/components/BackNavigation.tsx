...
export default function BackNavigation() {
  ...
  const whatsappPanelRef = useRef<HTMLDivElement>(null);
  ...
  useEffect(() => {
    if (!menuButtonRef.current || !whatsappPanelRef.current) return;
    ...
    const handleScroll = () => {
      ...
      gsap.to(whatsappPanelRef.current, {
        top: '1.5rem',
        right: '1.4rem',
        duration: 0.3,
        ease: 'power2.out'
  ...
  return (
    <nav className={`${styles.navigation} ${isWhatsappHovered ? styles.whatsappActive : ''}`}>
      {/* Dark Overlay */}
      <div
      ...
      {/* Back Link Container */}
      <div ref={menuButtonRef} className={styles.backButton}>
      ...
      >
        ...
        <div className={styles.whatsappOverlay}>
          <Image
        ...
        <div className={styles.whatsappContent}>
          <div className={styles.whatsappContentInner}>
